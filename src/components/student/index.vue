...
<template>
  <div id="student">
    <el-row class="padding-50">
      <el-col :span="24">
        <ul class="list">
          <li class="logo"><i class="iconfont icon-kaoshi"></i><span>心理健康信息系统</span></li>
          <li><a href="javascript:;" @click="health()">心理健康资讯</a></li>
          <li><router-link to="/myhealth">心理健康评测</router-link></li>
          <li><router-link to="/message">心理悄悄话</router-link></li>
